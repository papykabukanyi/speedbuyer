...
app.post('/api/products', async (req, res) => {
  ...
  try {
    ...
    const product = { id: uuid(), ...data, url: resolvedUrl, sourceUrl: url, addedAt: new Date().toISOString(), priceHistory: data.price !== null ? [{ price: data.price, at: data.lastChecked }] : [] };
